...
const CustomToggleSwitch = ({ size = 'large', showLabel: showText = true, color = 'success', isChecked = false, isDisabled = false, type = 'default', title, supportingText, onChange, }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "flex gap-3 items-center", children: [(0, jsx_runtime_1.jsx)(antd_1.Switch, { defaultChecked: isChecked, checked: isCheckedState, onChange: handleChange, checkedChildren: showText ? 'ON' : '', unCheckedChildren: showText ? 'OFF' : '', disabled: isDisabled, size: size === 'small' ? 'small' : 'default', className: `${color === 'success' ? 'default' : 'brand'} ${size === 'small' ? '!h-[20px]' : '!h-[24px]'}` }), type === 'text' && ((0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col gap-1 -mt-0.5", children: [title && ((0, jsx_runtime_1.jsx)(Typography_1.default, { variant: "paragraph-small", className: "!font-normal !text-text-secondary", children: title })), supportingText && ((0, jsx_runtime_1.jsx)(Typography_1.default, { variant: "paragraph-medium", className: "!font-normal !text-text-quinary", children: supportingText }))] }))] }));
};
